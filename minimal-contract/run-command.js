/**
 * Script to run the alkane execute command and capture the output
 */
...
// Command to execute
const command = './oyl-sdk/bin/oyl.js alkane execute -id 2:0 -data 2,699,1 -p oylnet';

// File to write the output to
const outputFile = 'command-output.txt';
