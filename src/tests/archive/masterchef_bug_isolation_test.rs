...
// Isolated setup to debug MasterChef calculation
fn create_debug_vault_setup() -> Result<(AlkaneId, AlkaneId, AlkaneId)> {
    clear();
                        ...
                        vec![
                            Protostone {
                                message: into_cellpack(vec![
                                    6u128, 797u128, 0u128, 100000u128, 1000u128, 100000u128,
                                    0x44454255, 0x47544553, 0x444247, 4u128, 0x37a,
                                ]).encipher(),
    ...
    // Initialize vault - LARGE temporal cap to isolate MasterChef bug
                        ...
                        vec![
                            Protostone {
                                message: into_cellpack(vec![
                                    ...
                                    1000u128, // reward per block
                                    3u128,    // start block
                                    1000u128, // LARGE temporal cap to isolate MasterChef bug
                                    free_mint_id.block, free_mint_id.tx,
                                ]).encipher(),
                                protocol_tag: AlkaneMessageContext::protocol_tag() as u128,
                                pointer: Some(0),
                                refund: Some(0),
